...
type SimpleServiceClient interface {
	GetSomething(ctx context.Context, in *SomeQuery, opts ...grpc.CallOption) (*SomeResponse, error)
}
...
func (c *simpleServiceClient) GetSomething(ctx context.Context, in *SomeQuery, opts ...grpc.CallOption) (*SomeResponse, error) {
	out := new(SomeResponse)
	err := c.cc.Invoke(ctx, "/simple.SimpleService/GetSomething", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SimpleServiceServer interface {
	GetSomething(context.Context, *SomeQuery) (*SomeResponse, error)
...
func (UnimplementedSimpleServiceServer) GetSomething(context.Context, *SomeQuery) (*SomeResponse, error) {
...
func _SimpleService_GetSomething_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SomeQuery)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SimpleServiceServer).GetSomething(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/simple.SimpleService/GetSomething",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SimpleServiceServer).GetSomething(ctx, req.(*SomeQuery))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _SimpleService_GetSomething_Handler,
		},
	},
